...
export interface BSA63CertificateContent {
    // Section 63(1) - Computer output requirements
    computerOutput: {
        description: string;
        producedBy: string;
        productionDate: Date;
    ...
    // Section 63(3) - Certificate details
    certificateDetails: {
        identifier: string;
...
export interface EntityEdge {
    ...
    relationship: string;
    weight: number;
    evidence: string[]; // Document/evidence IDs supporting this relationship
    caseId: string;
}
...
export interface CaseAnalytics {
    ...
    uniqueActors: number;
    timelineSpan: { start: Date; end: Date };
...
// ============================================================================
// ANOMALY DETECTION (for SIEM integration)
// ============================================================================
...
export interface AnomalyRule {
    ...
    condition: string; // e.g., "downloads > 50 in 1 hour"
    threshold: number;
